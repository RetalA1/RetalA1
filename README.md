I'm a high school student working on the intersection of AI & quantum security with a mathematical approach (Lattice based Crypto & Probabilities), while focusing on AI frameworks for security and building post quantum resilient architecture (PQC Benchmarking, Mitigation, and quantum-safe cloud security). 
